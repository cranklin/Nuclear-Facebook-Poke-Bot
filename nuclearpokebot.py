...
def pokeback():
    ...
    while True:
        ...
        buf.close()
        #print curlData
        pokedata = re.findall(ur"<div class=\"pokeHeader fsl fwb fcb\"><a href=\"(.*?)\" data-hovercard=\"\/ajax\/hovercard\/user.php\?id=([0-9]*)\">([^<]*)<\/a> has poked you.<\/div>",curlData)
        #print pokedata
